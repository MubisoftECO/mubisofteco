    ...
    public void generateAppUsers() {
        ...
        for (long id = 1; id <= userNames.length - 5; id++) {
            ...
            this.insertUser(new AppUser(
                    ...
                    userNames[(int) (id - 1)][0].toLowerCase() + "@" + userNames[(int) (id - 1)][1].toLowerCase(),
        ...
        this.insertUser(new AppUser(
            8L, userNames[7][0], userNames[7][1],
                ...
                userNames[7][0].toLowerCase() + "@" + userNames[7][1].toLowerCase(),
        ...
        this.insertUser(new AppUser(
                ...
                userNames[8][0].toLowerCase() + "@" + userNames[8][1].toLowerCase(),
        ...
        this.insertUser(new AppUser(
                ...
                userNames[9][0].toLowerCase() + "@" + userNames[9][1].toLowerCase(),
        ...
        this.insertUser(new AppUser(
                ...
                userNames[10][0].toLowerCase() + "@" + userNames[10][1].toLowerCase(),
        ...
        this.insertUser(new AppUser(
                ...
                userNames[11][0].toLowerCase() + "@" + userNames[11][1].toLowerCase(),
